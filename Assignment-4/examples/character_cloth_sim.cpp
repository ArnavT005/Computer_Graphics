...
int main() {
    ...
    upperArm[0].setCollisionParameters(0.05, 0.05);
    ...
    upperArm[1].setCollisionParameters(0.05, 0.05);
    ...
    lowerArm[0].setCollisionParameters(0.05, 0.05);
    ...
    lowerArm[1].setCollisionParameters(0.05, 0.05);
